...
# Common toolchain definitions for plugins
...
# Common directories for plugins
MACLIBS= -I../../asmmac -I../../asmchdr $(MACLIBS_BASE)
MTL_HEADERS=$(MTL_HEADERS_BASE) -I../../c/chdsect -I../../c

BIND=ld

# Common flags for plugins
C_FLAGS_COMMON=-I../../c/chdsect -I../../c
CPP_FLAGS_COMMON=-I../../c/chdsect -I../../c
