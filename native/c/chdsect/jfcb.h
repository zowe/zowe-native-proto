...
struct jfcb {
  ...
  struct {
    struct {
      unsigned char  _jfcbmsk1; /* -   OPEN switches byte 1                        @PAA */
      unsigned char  _jfcbmsk2; /* -   OPEN switches byte 2                        @PAA */
      unsigned char  _jfcbmsk3; /* -   OPEN switches byte 3                        @PAA */
      unsigned char  _jfcbmsk4; /* -   OPEN switches byte 4                        @PAA */
      unsigned char  _jfcbmsk5; /* -   OPEN switches byte 5                        @PAA */
      } jfcbops1;
...
#define jfcbmsk1 jfcbmask.jfcbops1._jfcbmsk1
#define jfcbmsk2 jfcbmask.jfcbops1._jfcbmsk2
#define jfcbmsk3 jfcbmask.jfcbops1._jfcbmsk3
#define jfcbmsk4 jfcbmask.jfcbops1._jfcbmsk4
#define jfcbmsk5 jfcbmask.jfcbops1._jfcbmsk5
...
/* Values for field "jfcbmsk5" */
#define jfcbmodj 0x80 /* - OPEN TYPE=J should update the system copy of     */
...
#define jfcvldq1 0x80 /* First volser in JFCBVOLS has been dequeued  @05A   */
#define jfcvldq2 0x40 /* Second volser in JFCBVOLS has been dequeued @05A   */
#define jfcvldq3 0x20 /* Third volser in JFCBVOLS has been dequeued  @05A   */
#define jfcvldq4 0x10 /* Fourth volser in JFCBVOLS has been dequeued @05A   */
#define jfcvldq5 0x08 /* Fifth volser in JFCBVOLS has been dequeued  @05A   */
