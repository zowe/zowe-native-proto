...
int create_with_attributes(const ParseResult &result)
{
  int rc = 0;
  ...
  {
    attributes.alcunit = result.get_value<string>("alcunit", "");
  }
  ...
  if (result.has("dsorg"))
  {
    attributes.dsorg = result.get_value<string>("dsorg", "");
  }
  ...
  if (result.has("recfm"))
  {
    attributes.recfm = result.get_value<string>("recfm", "");
  }
  if (result.has("lrecl"))
  {
  ...
  {
    attributes.dataclass = result.get_value<string>("dataclass", "");
  }
  if (result.has("unit"))
  {
    attributes.unit = result.get_value<string>("unit", "");
  }
  if (result.has("dsntype"))
  {
    attributes.dsntype = result.get_value<string>("dsntype", "");
  }
  if (result.has("mgntclass"))
  {
    attributes.mgntclass = result.get_value<string>("mgntclass", "");
  }
  if (result.has("dsname"))
  {
    attributes.dsname = result.get_value<string>("dsname", "");
  }
  ...
  {
    attributes.storclass = result.get_value<string>("storclass", "");
  }
  if (result.has("vol"))
  {
    attributes.vol = result.get_value<string>("vol", "");
  }
