...
static int zjsm_create_entry(JSON_INSTANCE *PTR32 instance, KEY_HANDLE *PTR32 parent_handle, const char *PTR32 *PTR32 entry_name, const char *PTR32 *PTR32 entry_value, int *PTR32 entry_type, KEY_HANDLE *PTR32 new_entry_handle)
{
