...
// initializePingHandlers initializes ping command handlers
func initializePingHandlers(disp *CmdDispatcher) {
	disp.MustRegister("ping", HandlePingRequest)
}
